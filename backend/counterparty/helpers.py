                ...
                vehicle_type["services"].append(
                    {
                        ...
                        "employer_salary": legal_entity_service.employer_salary if hasattr(legal_entity_service, 'employer_salary') else 0,
                        "percentage_for_washer": legal_entity_service.percentage_for_washer if hasattr(legal_entity_service, 'percentage_for_washer') else 0,
                        "to_be_added": True,
                        "to_be_removed": False,
                    }
                )
